...
namespace CarReportSystem {
    public partial class Form1 : Form {
        ...
        private void btDeleteReport_Click(object sender, EventArgs e) {
            DataGridViewSelectedRowCollection scr = dgvCarReports.SelectedRows;
            for (int i = scr.Count - 1; i >= 0; i--) {
                dgvCarReports.Rows.RemoveAt(scr[i].Index);
            }
        }
        ...
        private void btModifyReport_Click(object sender, EventArgs e) {
            ...
            dgvCarReports.CurrentRow.Cells[4].Value = pbCarImage.Image;
        }
